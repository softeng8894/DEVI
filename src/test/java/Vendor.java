    ...
    public void OpenBrowser() throws InterruptedException  {
    	 ...
    	 try (Playwright playwright = Playwright.create()) {
    	      ...
    	      Page page = context.newPage();
    	          ...
    	          Thread.sleep(2000);
    	          page.getByPlaceholder("Manifest Title").fill("HPOKIE3");
    	          Thread.sleep(2000);
    	          page.getByPlaceholder("Manifest SKU").click();
    	          Thread.sleep(2000);
    	          page.getByPlaceholder("Manifest SKU").fill("HPSKU3");
    	          Thread.sleep(2000);
    	          ...
    	          Thread.sleep(2000);
    	          page.getByPlaceholder("Quantity", new Page.GetByPlaceholderOptions().setExact(true)).fill("5");
    	          Thread.sleep(2000);
